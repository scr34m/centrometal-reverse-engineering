...
'''
To init the crypto the password is required as 5th parameter, other keys are extracted from FW.
Password can be obtained from MQTT connection to the portal.
centrometal.json_sign_init("158208e846", "65e0158208", "e84665e065", "e0158208e8", "")
'''
